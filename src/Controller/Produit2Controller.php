...
class Produit2Controller extends AbstractController
{
    ...
    /**
     * @Route("/list/{id}", name="produit2_list_par_categorie", methods={"GET"})
     */
    public function listParCateg(Categorie $categorie,CategorieRepository $categorieRepository): Response
    {
        // on exploite ici le concept paramConverter
        // $categorie = $categorieRepository->find($id);
       
        return $this->render('produit2/listeparcateg.html.twig', [
            'categorie' => $categorie
        ]);
    }
